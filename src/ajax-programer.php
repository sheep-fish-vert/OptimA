<?php
    ...
    if(isset($_POST['contact_area'])) {
        $area = substr(htmlspecialchars(trim($_POST['contact_area'])), 0, 100);
        $mess .= '<b>Сообщение </b> ' . $tel . '<br>';
    }
    ...
    $mail = new PHPMailer();
    $mail->AddAddress('sales@redcaviar.ru','');   // кому - адрес, Имя
